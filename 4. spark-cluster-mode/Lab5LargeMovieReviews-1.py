...
ss = SparkSession.builder.appName("lab5_1").getOrCreate()
...
output_path = "%s/Lab5_large_Sorted_Adventure_Movies"%projectPath
Top_Adventure2_DF.rdd.saveAsTextFile(output_path)
